...
export function BottomNav() {
  ...
  return (
    <nav className="fixed inset-x-4 bottom-4 z-40 rounded-3xl border border-white/12 bg-white/8 p-2 shadow-[0_20px_60px_rgba(8,15,30,0.45)] backdrop-blur-xl md:hidden">
